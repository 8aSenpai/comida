                ...
                <div class="card-body mod_card_body">  
                    ...
                    <div class="row">  
                        ...
                        <div class="col-sm-12 col-md-8 ad_cobro_men_fix"> 
                            ...
                            @endif
                            @foreach($pago_tarjeta as $key => $efectivo)
                            <div class="row ad_con_row">
                                <div class="col-6 ad_con_tab">
                                    <b>Numero de orden: </b> {{ $efectivo->no_orden }}
                                </div>
                                <div class="col-6 ad_con_tab">
                                    <b>Monto: </b>${{ $efectivo->monto }} MXN
                                </div>
                                <div class="col-6 ad_con_tab">
                                    <b>Numero de folio: </b>{{ $efectivo->no_folio }}
                                </div>
                                <div class="col-6 ad_con_tab">
                                    <b>INE: </b>{{ $efectivo->ine }}
                                </div>
                                <div class="col-12 ad_con_tab">
                                    <b>Fecha: </b>{{ $efectivo->fecha }}
                                </div>
                            </div>
                            @endforeach
                        </div>  
